...
//
///** 
// *  Sets the time when the node is going offline time is measured on the basis
// *  of simulation time with CommonState.getTime().
// *  -1 stands for a node with no session endtime
// */
//public void setSessionEnd(long end);
